...
* This talk is not arguing for or against the current process
   + Simply reporting the pipeline that is common to large organizations to:
...
* Donna Evans, HR guru 
* Jordan Creed (@jhcreed), unicoRn hex sticker guru
* Garrick Aden-Buie (@grrrck), `xaringanExtra` creator + all around CSS/JS guru
* Tampa R Users Group (@UseRTampa), the feedback gurus
